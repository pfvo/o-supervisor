...
myCanvas.addEventListener('touchstart', drawStart)
myCanvas.addEventListener('touchend', drawEnd)
myCanvas.addEventListener('touchmove', draw2)
myCanvas.addEventListener('touchcancel', drawEnd)
